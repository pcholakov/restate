...
pub enum TaskKind {
    ...
    Ingress,
    PartitionProcessor,
    /// A background task not directly involved on the processing path.
    // todo(pavel): move the trigger responsibility to cluster scheduler
    PartitionProcessorBackground,
