...
pub(crate) fn cf_options() -> impl Fn(rocksdb::Options) -> rocksdb::Options + Send + Sync + 'static
{
    ...
    move |mut cf_options| {
        ...
        cf_options
            .set_memtable_prefix_bloom_ratio(bloom_filter_size as f64 / write_buffer_size as f64);
...
fn set_memory_related_opts(opts: &mut rocksdb::Options, write_buffer_size: usize) {
